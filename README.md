...
* [**Lumix**, an event management application](https://github.com/shahjacobb/Event-Creation-App)
  * written with React components for the frontend, and powered entirely by AWS lambda functions for server side logic, AWS DynamoDB for data store/management, and API gateway for endpoint configuration
*
